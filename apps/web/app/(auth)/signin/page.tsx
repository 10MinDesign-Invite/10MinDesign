      ...
      <Card className="w-full max-w-md bg-gradient-to-br from-gray-900 to-black border border-neutral-700 shadow-xl rounded-2xl">
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <Link href={"/forgot"}>
              <button className="group mt-2 flex items-center gap-2 text-sm font-medium mx-auto text-gray-600 hover:text-blue-600 transition-colors duration-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <path
                    ...
                    d="M12 11c0-1.105.895-2 2-2s2 .895 2 2v1m-4 0h8v10H4V12h8z"
                  />
                </svg>
