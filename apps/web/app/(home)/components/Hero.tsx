    ...
    const items = isDesktop
     ...
     useGSAP(() => {
        ...
        mm.add("(min-width: 1280px)", () => {
            ...
            gsap.fromTo("#home-images-main-div",
        ...
        <main className="p-2">
            <section className="borde grid grid-cols-1 lg:mt-4 xl:grid-cols-2">
                ...
                <div id="home-images-main-div" className=" w-[400px] md:w-[90%] mx-auto p-2 xl:opacity-0 border grid md:grid-cols-2 lg:mt-[122px] gap-2 mt-[100px] xl:mt-4 rounded-3xl overflow-hidden shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
                    ...
                    <div id="card-one" className="home-images-div borde opacity-0 lg:opacity-100 xl:opacity-0 h-[450px] overflow-scroll p-2 grid gap-5 md:pt-[25px] lg:pt-[30px] lg:mt-[50px] scrollbar-hide rounded-2xl ">
                        <Image
                    ...
                    <div id="card-two" className="home-images-div h-[450px] opacity-0 lg:opacity-100 xl:opacity-0 overflow-scroll hidden p-2 md:grid gap-5 scrollbar-hide rounded-2xl md:pt-[15px]">
                        <Image
