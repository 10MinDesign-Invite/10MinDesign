...
export function Wedding1() {
    ...
    const [firstNameInfo1, setFirstNameInfo1] = useState("डॉ.दयाल घुंगरु यांचा मुलगा.")
    const [firstName2, setFirstName2] = useState("संजना")
    const [firstNameInfo2, setFirstNameInfo2] = useState("उदय शंकर शेट्टी यांची बहिण.")
    const [date1, setDate1] = useState("बुधवार दि. १२/०९/२०२५ रोजी सायं ०५:३० वा")
    const [date2, setDate2] = useState("बुधवार दि. १२/०९/२०२५ रोजी सायं ११:०० वा व दुपारी ०२:०० वा (विवाहस्थळी)")
    ...
    const [sizes,setSizes] = useState({name1:1, name2:1, firstName1:1, firstNameInfo1:1,firstName2:1,firstNameInfo2:1, Date2:1, location:1,Info:1,relats:1,invite:1 })
        ...
        <DesignWraper customeStyles="flex flex-col lg:flex-row items-center lg:items-start text-black">
            <DetailWrapper customeStyles="relative w-full md:w-[70%] dark:text-white mb-[25px] lg:mb-0 dark:shadow-[inset_0px_0px_14px_0px_#e53e3e] shadow-[0px_7px_13px_0px_#63b3ed]">
                <div className="w-full gap-[3.5%]">
                    <div className="w-[80%] flex justify-end items-center mb-2">
                        <input type="file" onChange={getCoupleImage} accept="image/*" placeholder="select your image" className="rounded-md bg-red-300 text-black w-[75%]"/>
                    </div>
                    <button className="bg-green-400 text-black px-2 py-1 rounded-lg mb-2" onClick={() => handleDownload(containerRef)}> dwonload</button>
                </div>
                        ...
                        whichSize == "name1 And name2" &&(
                            <div className="w-full bg-white">
                                <div className="flex justify-end">
                                    <div onClick={()=>setWhichSize("")} className="w-[30px] cursor-pointer bg-red-400">X</div>
                                </div>
            ...
            <DesignContainer customeStyles="w-[80%]">
                ...
                <div ref={containerRef} className="relative w-full h-full md:h-[auto] mx-auto flex justify-center items-center">
                    ...
                    <p style={{fontSize:`${sizes.firstNameInfo1 == 1 ? undefined : `${sizes.firstNameInfo1}px`}`,lineHeight:"120%"}} className="flex items-center leading-[2vw] lg:leading-[1vw] whitespace-pre-wrap break-words absolute scrollbar-hide top-[12.5%] left-[60.1%] w-[40%] h-[7.3%] font-bold text-left text-[1.7vw] lg:text-[0.8vw] xl:text-[12.5px] overflow-x-hidden text-red-800">
                        {firstNameInfo1}
                    </p>

                    <p style={{fontSize:`${sizes.firstNameInfo2 == 1 ? undefined : `${sizes.firstNameInfo2}px`}`,lineHeight:"120%"}} className="flex items-center whitespace-pre-wrap leading-[2vw] lg:leading-[1vw] break-words absolute scrollbar-hide top-[22.3%] left-[60.1%] w-[40%] h-[7.3%] font-bold text-[1.6vw] lg:text-[0.8vw] xl:text-[12.5px] text-left overflow-x-hidden text-red-800">
                        {firstNameInfo2}
                    </p>
                    {/* third section */}
                    {/* images start */}
                    <div className="absolute w-[66.4%] h-[19%] top-[30%] left-[10.9%]">
                        <Image
                            ...
                            priority={true}
                        />
                        <div className={`absolute bottom-[14%] right-[5.7%] w-[68%] h-[15.5%] text-white font-bold text-[1.5vw] lg:text-[0.7vw] xl:text-[13px] bg-blac ${laila.className} flex justify-center items-center overflow-hidden`}>
                            {date1}
                        </div>
                        <div className={`absolute bottom-[0%] right-[9%] w-[65%] h-[14%] text-[1.5vw] lg:text-[0.7vw] xl:text-[13px] font-bold text-white bg-blac ${laila.className} flex justify-center items-center overflow-hidden`}>
                    ...
                    <div style={{fontSize:`${sizes.Info == 1 ? undefined : `${sizes.Info}px`}`, overflow:"hidden"}} className="absolute top-[71.4%] left-[2%] w-[48.5%] h-[5.5%] flex justify-center items-center text-[1.2vw] lg:text-[0.6vw] xl:text-[12.5px] font-bold">
                        {locationAdd}
                    </div>
                    {/* ================================================================================== */}
                    {/* sixth section */}
                    ...
                    <div style={{fontSize:`${sizes.relats == 1 ? undefined : `${sizes.relats}px`}`,lineHeight: "120%"}} className="leading-[2vw] lg:leading-[1vw] xl:text-[12.5px] whitespace-pre-wrap break-words absolute top-[81.5%] left-[2%] w-[48.5%] h-[12%] font-bold flex justify-center items-center text-[1.6vw] lg:text-[0.8vw] overflow-hidden text-red-800">
                        {relats}
                    </div>
                    {/* ===================================================================================== */}
                    {/* sixth section */}
