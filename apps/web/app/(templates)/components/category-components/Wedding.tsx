...
const [currentDesign,setCurrentDesign] = useState({wedding:"",image:""})
    const images = [
        {
            wedding: "Wedding1",
            ...
            <div className="pb-9 mt-[30px]  grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 px-5 sm:gap-6 md:gap-7 lg:gap-10">
                            {
                                images.map((cur,index) => {
                                    return (
                                        <div key={cur.wedding} className="outline backdrop-blur-xl bg-slate-200 rounded-xl relative mb-4 md:mb-0 overflow-x-hidden">
                                            ...
                                            <div className=" text-white flex flex-col w-[90%] mx-auto h-[85px] pt-1 px-1 mt-1">
                                                ...
                                                <Link className="w-[90%] mx-auto" href={`/category/wedding/${cur.wedding}`}>
                        ...
                        <div className={`${currentDesign.wedding == "" ? "hidden" : "block" } inset-0 overflow-auto fixed top-0 left-0 w-full h-[100%] backdrop-blur-2xl text-white z-50`}>
                            <WeddingDesign setCurrentDesign={setCurrentDesign} currentDesign={currentDesign}/>
                        </div>
        </div>
