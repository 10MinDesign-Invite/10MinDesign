...
export const metadata: Metadata = {
  ...
  description: "Discover 10MinDesign – your destination for fast, professional, and elegant invitation card designs.",
};

export default function AboutPage() {
  return (
    <section className="max-w-5xl mx-auto px-6 py-16 text-slate-800 dark:text-slate-200 transition-colors">
      {/* Title */}
      ...
      <p className="text-center text-lg text-slate-600 dark:text-slate-400 mb-12">
        Beautifully crafted invitation cards – designed in minutes, shared in moments.
      </p>

      {/* Story */}
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-3 text-blue-700 dark:text-blue-400">Our Story</h2>
        <p className="leading-relaxed">
          10MinDesign was born from a simple idea — to make professional invitation cards accessible to everyone.
          Whether it's a wedding, birthday, or festive event, creating a stunning invite shouldn't require hours or a designer.
          Our platform brings elegance, speed, and ease together — so your moments shine from the start.
        </p>
      </div>

      {/* Services */}
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-3 text-blue-700 dark:text-blue-400">What We Offer</h2>
      ...
      {/* Vision */}
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-3 text-blue-700 dark:text-blue-400">Our Vision</h2>
        <p className="leading-relaxed">
          We envision a world where design meets simplicity. Our mission is to help individuals and businesses express themselves with
          beautiful, modern, and hassle-free invitations — all within 10 minutes.
        </p>
      </div>
      ...
      <div className="mt-16 mb-20 bg-gradient-to-r from-violet-600 to-blue-600 dark:from-violet-500 dark:to-blue-500 text-white p-8 rounded-2xl shadow-lg text-center">
        ...
        <p className="mb-4 text-lg">
          Want something unique? We offer personalized invitations just for you!
