...
var require_library = __commonJS({
  "generated/client/runtime/library.js"(exports2, module2) {
    ...
    var _o = (e, r, t, n) => {
      if (r && typeof r == "object" || typeof r == "function") for (let i of wu(r)) !Pu.call(e, i) && i !== t && Vt(e, i, { get: () => r[i], enumerable: !(n = Eu(r, i)) || n.enumerable });
      return e;
    };
    ...
    var us = ne((Ng, ls) => {
      "use strict";
      var Mc = require("os"), as = require("tty"), de = fi(), { env: G } = process, Qe;
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    function Je(e, r) {
      ...
      if (r == null ? (w = false, c = b) : c = r, v.precision = c += g, t = J(I), n = t.charAt(0), Math.abs(o = h.e) < 15e14) {
        for (; n < 7 && n != 1 || n == 1 && t.charAt(1) > 3; ) h = h.times(e), t = J(h.d), n = t.charAt(0), f++;
        o = h.e, n > 1 ? (h = new v("0." + t), o++) : h = new v(n + "." + t.slice(1));
      } else return u = mn(v, c + 2, b).times(o + ""), h = Je(new v(n + "." + t.slice(1)), c - g).plus(u), v.precision = b, r == null ? y(h, b, S, w = true) : h;
      for (p = h, l = s = h = L(h.minus(1), h.plus(1), c, 1), d = y(h.times(h), c, 1), i = 3; ; ) {
        ...
        else return y(l, v.precision = b, S, w = true);
      ...
      for (let h in t) {
        ...
        for (let v = 0; v < I.length; ++v) {
          ...
          for (let V = n, te = i; V < r.length; te += r[V].length, ++V) {
            ...
            if (H.push(fr), g && H.push(g), Array.prototype.splice.apply(r, H), u != 1 && P.matchGrammar(e, r, t, V, te, true, h), o) break;
          }
        }
      }
      ...
      class r {
        ...
        _request(n) {
          ...
          let i = n.middlewareArgsMapper ?? Ff, o = { args: i.requestArgsToMiddlewareArgs(n.args), dataPath: n.dataPath, runInTransaction: !!n.transaction, action: n.action, model: n.model }, s = { middleware: { name: "middleware", middleware: true, attributes: { method: "$use" }, active: false }, operation: { name: "operation", attributes: { method: o.action, model: o.model, name: o.model ? `${o.model}.${o.action}` : o.action } } }, a = -1, l = async (u) => {
            ...
            if (c) return this._tracingHelper.runInChildSpan(s.middleware, (I) => c(u, (v) => (I == null ? void 0 : I.end(), l(v))));
...
var require_client = __commonJS({
  "generated/client/index.js"(exports2) {
    ...
    exports2.Prisma.OtpStoreScalarFieldEnum = {
      id: "id",
      email: "email",
      otp: "otp"
    };
    ...
    var config = {
      ...
      "inlineSchemaHash": "38db070c8109c307a7d658975fcec746ae0662032b4cd7803915eb78f16df882",
      "copyEngine": true
    };
    var fs = require("fs");
